<div class="sidepanel-inner d-flex flex-column">
    ...
    <nav id="app-nav-main" class="app-nav app-nav-main flex-grow-1">
        <ul class="app-menu list-unstyled accordion" id="menu-accordion">
            ...
            <li class="nav-item has-submenu">
                ...
                <div id="submenu-1" class="collapse submenu submenu-1" data-bs-parent="#menu-accordion">
                    <ul class="submenu-list list-unstyled">
                        ...
                        <li class="submenu-item"><a class="submenu-link" href="../inventario/articulos.php">Artículos</a></li>
                        <li class="submenu-item"><a class="submenu-link" href="../inventario/categorias.php">Categorías</a></li>
                        <li class="submenu-item"><a class="submenu-link" href="../inventario/proveedores.php">Proveedores</a></li>
                    </ul>
                </div>
            </li>
            ...
            <li class="nav-item has-submenu">
                ...
                <div id="submenu-2" class="collapse submenu submenu-2" data-bs-parent="#menu-accordion">
                    <ul class="submenu-list list-unstyled">
                        ...
                        <li class="submenu-item"><a class="submenu-link" href="../Inventario/equipoCompu.php">Equipo</a></li>
                        <li class="submenu-item"><a class="submenu-link" href="rutaRed.php">Ruta red</a></li>
                    </ul>
                </div>
            </li>
            ...
            <li class="nav-item has-submenu">
                ...
                <div id="submenu-3" class="collapse submenu submenu-3" data-bs-parent="#menu-accordion">
                    <ul class="submenu-list list-unstyled">
                        ...
                        <li class="submenu-item"><a class="submenu-link" href="solicitarMante.php">Solicitar</a></li>
                        <li class="submenu-item"><a class="submenu-link" href="finalizarMante.php">Finalizar</a></li>
                    </ul>
                </div>
            </li>
            ...
            <li class="nav-item has-submenu">
                ...
                <div id="submenu-4" class="collapse submenu submenu-4" data-bs-parent="#menu-accordion">
                    <ul class="submenu-list list-unstyled">
                        ...
                        <li class="submenu-item"><a class="submenu-link" href="../inventario/reportePrestamo.php">Préstamo</a></li>
                        <li class="submenu-item"><a class="submenu-link" href="../inventario/reporteAsignacion.php">Asignación</a></li>
                        <li class="submenu-item"><a class="submenu-link" href="reporteMante.php">Mantenimiento</a></li>
                        <li class="submenu-item"><a class="submenu-link" href="reporteRedes.php">Redes</a></li>
                    </ul>
                </div>
            </li>
            ...
            <li class="nav-item">
                <!--<a class="nav-link" onclick="loadFileUsuarios('perfil','loadPage')">-->
                <a class="nav-link" href="../usuarios/perfil.php">
                    <span class="nav-icon">
