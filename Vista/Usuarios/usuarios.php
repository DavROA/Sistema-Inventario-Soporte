            ...
            <h1 class="app-page-title">Usuarios</h1>
                    ...
                    <div class="col-auto">
                        <div class="page-utilities">
                            <div class="row g-2 justify-content-start justify-content-md-end align-items-center">
                                ...
                                <div class="col-auto">
                                    <button type="button" class="btn app-btn-secondary"  onclick="loadFileUsuarios('agregarUsuario','loadPage')">
                                        Agregar usuario
                                    </button>
                                </div>
                            </div>
                ...
                <nav id="orders-table-tab" class="orders-table-tab app-nav-tabs nav shadow-sm flex-column flex-sm-row mb-4">
                    <a class="flex-sm-fill text-sm-center nav-link active" id="orders-all-tab" data-bs-toggle="tab" href="#orders-all"
                        role="tab" aria-controls="orders-all" aria-selected="true">Todos los usuarios</a>
                    <a class="flex-sm-fill text-sm-center nav-link" id="orders-paid-tab" data-bs-toggle="tab" href="#orders-paid"
                        role="tab" aria-controls="orders-paid" aria-selected="false">Personal</a>
                    <a class="flex-sm-fill text-sm-center nav-link" id="orders-pending-tab" data-bs-toggle="tab" href="#orders-pending"
                        role="tab" aria-controls="orders-pending" aria-selected="false">Administrativo</a>
                    <a class="flex-sm-fill text-sm-center nav-link" id="orders-cancelled-tab" data-bs-toggle="tab"
                        href="#orders-cancelled" role="tab" aria-controls="orders-cancelled" aria-selected="false">Inactivos</a>
                </nav>
                                    ...
                                    <table class="table app-table-hover mb-0 text-left">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="cell">...</td>
                                                <td class="cell"><span class="badge bg-success">Personal</span></td>
